...
`Python 3.13 + Flask` · `React + Vite + Tailwind` · `10 agent CLIs: opencode, codex, claude, pi, kilo, qwen, cline, grok, commandcode, agy` · `Localhost only` · `One port: 2052`
